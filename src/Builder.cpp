...
{
	for(unsigned int i=0; i<data->getNumberOfElements();i++)		//stvara elemente
		data->getElements()[i]->spawnThisElmenet();

	for(unsigned int i=0; i<data->getConnDescr().size(); i++)		//povezuje elemente
	{
...
void Builder::link(ID id1, unsigned int pin1, ID id2, unsigned int pin2)		//povezivanje elemenata na osnovu id-ja
